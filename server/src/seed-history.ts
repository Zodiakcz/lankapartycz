 ...
 * Run with: npx tsx src/seed-history.ts
 *
...
const attendance: HistoricalAttendance[] = [
  // Dobi
...
async function main() {
  ...
  for (const att of attendance) {
    ...
    // Find party start date to calculate arrival/departure
